    ...
    if(!_this.diagrams[i].orphan){
      ...
      for(var j = 0; j < _this.diagrams[i].parents.length; j++){
        ...
        if(autoRef){
          ...
          _this.context.context.setLineDash([_this.config.lineWidth * 2]);
          _this.context.beginPath();
          _this.context.strokeStyle = _this.config.lineColor || _this.diagrams[i].bgColor;
          ...
          _this.context.beginPath();
          _this.context.strokeStyle = _this.config.lineColor || _this.helper.colorLuminance(_this.diagrams[i].bgColor, -0.2);
          ...
          _this.context.fillStyle = _this.config.lineColor || _this.helper.colorLuminance(_this.diagrams[i].bgColor, -0.2);
          _this.context.beginPath();
